...
def create_test_suite(content):
    prompt = f"""
    Provide a complete test suite for the given Java code using the Spring framework with maximum code coverage. Use JUnit5 and Mockito for creating the tests. Focus on covering all possible branches and edge cases.
    ...
    Moreover the path of the file is {content['filePath']} so that you can import the package name too.
...
def update_test_suite(sourceCode, testCode, error):
    if error == None:
        print("modify")
        prompt = f"""
            Provide the missing tests for the given Java code using the Spring framework with maximum code coverage. Use JUnit5 and Mockito for creating the tests. Focus on covering all possible branches and edge cases.
            If it's not java code file reply with just 'not a java file'.
            In some case, there could be some comments to document the method to test like the following case:
            /*
            Function to test the absolute value of the sum of the parameters
            */
            ...
            Moreover the path of the file is {sourceCode['filePath']} so that you can import the package name too.
        ...
        print("modify")
        prompt = f"""
            Fix the test for the given Java code using the Spring framework with maximum code coverage. Use JUnit5 and Mockito for creating the tests. Focus on covering all possible branches and edge cases.
            If it's not java code file reply with just 'not a java file'.
            In some case, there could be some comments to document the method to test like the following case:
            /*
            Function to test the absolute value of the sum of the parameters
